...
def patch_teacher_forced_flow_loss_forward() -> None:
    ...
    """
    if not hasattr(Alpamayo1_5, "teacher_forced_flow_loss_forward"):
        Alpamayo1_5.teacher_forced_flow_loss_forward = _teacher_forced_flow_loss_forward
...
def main():
    ap = argparse.ArgumentParser(description="Quantize Alpamayo1_5 and export as HF checkpoint")
    ap.add_argument(
        "--ckpt",
        type=str,
